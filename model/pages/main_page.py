...
class MainPage(Base):
    ...
    def get_burger_menu(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(self.burger_menu))

    def get_smartphones_section(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(self.smartphones_section))

    def get_apple_iphone_section(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(self.apple_iphone_section))

    def get_title_apple_iphone_section(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(self.title_apple_iphone_section))
